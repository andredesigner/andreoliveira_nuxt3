<script setup>
useHead({
  title: 'Projetos - André Oliveira | UX/UI Brand Designer',
  meta: [
    { name: 'description', content: 'Projetos meus selecionados de UX/UI, Web design e identidade visual.' },
    ...
    { property: 'og:description', content: 'Projetos meus selecionados de UX/UI, Web design e identidade visual.'},
